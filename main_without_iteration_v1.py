...
from simulation1.simulation import simulation
    ...
    for nodes_num, obs_num in test:
        ...
        for seed in range(5):
            ...
            if os.path.exists(obs_filepath_2):
                ...
                obs_filepath_2, true_net_filepath_2 = sim.do(K, nodes_num, node_dim, time, dt, true_net_re_filepath, seed)
        ...
        logging.info("%d x %d Average accuracy2: %.6f" % (nodes_num, obs_num, np.mean(acc2) ))
        logging.info("---------")
        print()
